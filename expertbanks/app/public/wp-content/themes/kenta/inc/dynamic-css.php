...
function kenta_transparent_header_css() {
	...
	// Raw text
	$css['.kenta-transparent-header, .kenta-transparent-header .kenta-data-time-element, .kenta-transparent-header .kenta-raw-html'] = Css::colors( CZ::get( 'kenta_trans_header_raw_text_color' ), [
		'text'    => [ 'color', '--kenta-data-time-text-color', '--kenta-data-time-icon-color' ],
		'initial' => '--kenta-link-initial-color',
		'hover'   => '--kenta-link-hover-color',
	] );
