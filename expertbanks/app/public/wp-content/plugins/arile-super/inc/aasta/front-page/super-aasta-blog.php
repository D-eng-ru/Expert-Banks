...
if($aasta_blog_disabled == true): ?>
	<section class="theme-block theme-blog theme-bg-grey <?php if('Appointech' == $activate_theme || 'Architect Studio' == $activate_theme){ echo 'vrsn-three';} ?>" id="theme-blog">
	 <?php if($aasta_blog_area_title != null || $aasta_blog_area_des != null): ?>
        ...
        $post_args = array( 'post_type' => 'post', 'posts_per_page' => 3, 'category__in' => $aasta_theme_blog_category, 'post__not_in'=>get_option("sticky_posts")) ;
			...
			{	
				...
				{ ?>
					<div class="col-lg-<?php if($activate_theme == 'InteriorHub' ||$activate_theme == 'Consultexo' || $activate_theme == 'Appointech' || 'Architect Studio' == $activate_theme) { echo '4'; } else { echo '6';}   ?> col-md-6 col-sm-12">
